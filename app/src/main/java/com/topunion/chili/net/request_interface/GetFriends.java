...
public class GetFriends {
    ...
    public interface IGetFriends {
        ...
        @GET("app/contacts/friend/getFriends")
        Call<ResponseData<GetFriendsResponse>> getFriendsByGroup(@Query("userId") String userId, @Query("groupId") String groupId, @Query("pageNo") int pageNo, @Query("pageSize") int pageSize);
    ...
    public static class GetFriendsResponse extends BaseListResponse {
        ...
        public List<SortModel> friendsTofilledData() {
            ...
            for (int i = 0; i < result.size(); i++) {
                if ("1".equals(result.get(i).inGroup)) {
                    continue;
                }
