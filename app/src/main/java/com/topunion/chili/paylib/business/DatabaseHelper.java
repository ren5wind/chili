...
public abstract class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public final void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        try {
            Log.i(TAG,"onupdate database...."+oldVersion+" to "+newVersion);
    ...
    /**
     * 创建数据库的回调
     * 可以使用 TableUtils.createTable(connectionSource, User.class);
     *
     * @param connectionSource
     */
    public abstract void onCreate(AndroidConnectionSource connectionSource) throws SQLException;
    ...
    private void onUpgrade(int oldVersion, int newVersion) {
        try {
            ...
            onUpgrade(oldVersion, newVersion, connectionSource);
        } catch (SQLException e) {
    ...
    /**
     * 更新数据库的回调
     * 可以使用 TableUtils，进行操作
     *
     * @param connectionSource
     */
    public abstract void onUpgrade(int oldVersion, int newVersion, AndroidConnectionSource connectionSource) throws SQLException;
